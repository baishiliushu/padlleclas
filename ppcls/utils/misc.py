...
class AttrMeter(object):
    ...
    def res(self):
        ...
        print("Recall_front: ",label_pos_recall[0])
        print("Recall_side: ",label_pos_recall[1])
        print("Recall_back: ",label_pos_recall[2])
        ...
        print("Accuracy_front: ",label_prec[0])
        print("Accuracy_side: ",label_prec[1])
        print("Accuracy_back: ",label_prec[2])
        ma = (np.mean(label_ma))
