...
if __name__ == '__main__':   
    data_path = "/home/leon/mount_point_two/rubby-data-track/nfs_label_work/dataset/train/person_19_20_0902_cut" #'/mnt/sda3/cut_img/person_19_20_0902'    
    # scene_paths os.listdir('back') os.path.isdir(deep_path)
    
    new_path = "/home/leon/mount_point_d/test-result-moved/peson-attr-train-test-data/datasets/train/person_19_20_0920_cut_0929picked"
                ...
                if n == 'normal':
                    ...
                    for c in LESS_AGU_TYPES:
                        if c in s:
                            ...
                            break
                    # do agu
                    path_cut = os.path.join(scene_path_new, 'cut')
                    ...
                    print("CUT {} TO {}".format(data_name_path_new, path_cut))

                path_filp = os.path.join(scene_path_new, 'flip_{}'.format(n))
